...
owner-approved — tags `v0.M62`…`v0.M69` (+ hotfix `v0.M69.1`), SW cache **v94**.
...
|---|---|
| Branch | `main` (clean) |
| Tests | **837 passing / 0 fail** (`npm test`) |
| Lint | clean (`npx eslint@9 --max-warnings=0 .`) |
| SW cache | `hermantrip-shell-v94` (in `sw.js`) |
| Latest tag | `v0.M69.1` (M8 Timeline + scrubber-replaces-slider hotfix). Ladder M1–M8 complete |
| Next SW bump | **v95** (only if a future hotfix ships) |
