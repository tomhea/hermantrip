...
owner-approved — tags `v0.M62`…`v0.M69` (+ hotfixes through `v0.M69.5`), SW cache **v98**.
...
|---|---|
| Branch | `main` (clean) |
| Tests | **847 passing / 0 fail** (`npm test`) |
| Lint | clean (`npx eslint@9 --max-warnings=0 .`) |
| SW cache | `hermantrip-shell-v98` (in `sw.js`) |
| Latest tag | `v0.M69.5` (M8 Timeline + 5 scrubber hotfixes). Ladder M1–M8 complete |
| Next SW bump | **v99** (only if a future hotfix ships) |
