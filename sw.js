...
const SHELL_CACHE = 'hermantrip-shell-v77';
const SHELL_FILES = [
  '/',
  '/index.html',
  '/src/main.js',
  ...
  '/src/lib/country-hero.js',
  '/src/lib/progressive-img.js',
  ...
  '/src/lib/globe-picker.js',
  '/src/lib/globe-buildings.js',
  '/src/lib/trail.js',
  '/src/lib/map-stops.js',
  '/src/lib/map-popup.js',
  '/src/lib/country-labels.js',
  '/src/lib/fullscreen-policy.js',
  '/src/lib/timeline.js',
  '/src/lib/game.js',
  '/icon.svg',
  '/favicon.ico',
